SELECT DISTINCT "r_coll_main"."coll_id", "r_coll_main"."parent_coll_name",
  ...
  "r_meta_main"."meta_attr_unit", "r_user_main"."user_name", "r_user_main"."zone_name",
  "r_objt_access"."access_type_id"
  FROM
  ...
  WHERE "r_meta_main"."meta_attr_unit" = 'iRODSUserTagging:Share'
    AND "r_user_main"."user_name" = 'test1' AND "r_user_main"."zone_name" = 'test1'
