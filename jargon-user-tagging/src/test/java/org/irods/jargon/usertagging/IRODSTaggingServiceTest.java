...
public class IRODSTaggingServiceTest {
	...
	public final void testAddTagToLiveDataObject() throws Exception {
		...
		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.addTagToDataObject(targetIrodsDataObject, irodsTagValue);
	...
	public final void testRemoveTagFromLiveDataObject() throws Exception {
		...
		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.addTagToDataObject(targetIrodsDataObject, irodsTagValue);
		irodsTaggingService.deleteTagFromDataObject(targetIrodsDataObject, irodsTagValue);

		Assert.assertEquals(0, irodsTaggingService.getTagsOnDataObject(targetIrodsDataObject).size());
	...
	public final void testQueryThreeTagsFromLiveDataObject() throws Exception {
		...
		List<IRODSTagValue> queryResultValues = irodsTaggingService.getTagsOnDataObject(targetIrodsDataObject);

		Assert.assertEquals("should have returned the three tags added", 3, queryResultValues.size());
	...
	@Test
	public final void testAddDescriptionCollectionThenAddBlankToDelete() throws Exception {
		...
		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.addDescriptionToCollection(targetIrodsCollection, irodsTagValue);
	...
	public final void testAddDescriptionToLiveCollection() throws Exception {
		...
		Assert.assertEquals("description not found in tag", expectedTagName, actualDescription.getTagData());

	}

	@Test
	public final void testAddDescriptionToLiveCollectionBlankDescriptionNoPrior() throws Exception {
		...
		IRODSTagValue irodsTagValue = new IRODSTagValue("", irodsAccount.getUserName());

		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.addDescriptionToCollection(targetIrodsCollection, irodsTagValue);

		IRODSTagValue actual = irodsTaggingService.getDescriptionOnCollectionForLoggedInUser(targetIrodsCollection);
		Assert.assertNull("should not be a description", actual);
	}

	@Test
	public final void testGetDescriptionOnLiveCollectionCollectionExistsNoDescription() throws Exception {
	...
	public final void testQueryTwoTagsOnLiveCollection() throws Exception {
		...
		Assert.assertEquals("should have returned the two tags added", 2, irodsTagValues.size());

		IRODSTagValue testTag1 = irodsTagValues.get(0);
		Assert.assertEquals("tag value is not what was expected", expectedTagName1, testTag1.getTagData());
		Assert.assertEquals("tag user is not what was expected", irodsAccount.getUserName(), testTag1.getTagUser());
		IRODSTagValue testTag2 = irodsTagValues.get(1);
		Assert.assertEquals("tag value is not what was expected", expectedTagName2, testTag2.getTagData());
		Assert.assertEquals("tag user is not what was expected", irodsAccount.getUserName(), testTag2.getTagUser());
	}
	...
	public final void testAddTwoTagsToACollectionThenDeleteOneTag() throws Exception {
		...
		Assert.assertEquals("should have returned only the first added tag", 1, irodsTagValues.size());
	...
	public final void testGetTagsBasedOnMetadataDomainCollection() throws Exception {
		...
		List<IRODSTagValue> irodsTagValues = irodsTaggingService.getTagsBasedOnMetadataDomain(MetadataDomain.COLLECTION,
	...
	public final void testAddDescriptionToLiveDataObject() throws Exception {
		...
		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.addDescriptionToDataObject(targetIrodsDataObject, irodsTagValue);
	...
	public final void testAddDescriptionToDataObjectTwice() throws Exception {
		...
		irodsTaggingService.addDescriptionToDataObject(targetIrodsDataObject, irodsTagValue);
		irodsTaggingService.addDescriptionToDataObject(targetIrodsDataObject, irodsTagValue);
		IRODSTagValue actual = irodsTaggingService.getDescriptionOnDataObjectForLoggedInUser(targetIrodsDataObject);
		Assert.assertNotNull("did not find data object", actual);

	}

	@Test
	public final void testAddBlankDescriptionToDataObjectNoPrior() throws Exception {
	...
	@Test
	public final void testAddDescriptionThenAddBlankDescriptionToDelete() throws Exception {
		...
		irodsTagValue = new IRODSTagValue("", irodsAccount.getUserName());
		irodsTaggingService.addDescriptionToDataObject(targetIrodsDataObject, irodsTagValue);
		IRODSTagValue value = irodsTaggingService.getDescriptionOnDataObjectForLoggedInUser(targetIrodsDataObject);
		Assert.assertNull("should have deleted data object description", value);
	}

	@Test
	public final void testDeleteDescriptionFromLiveCollection() throws Exception {
		...
		irodsTaggingService.deleteDescriptionFromCollection(targetIrodsCollection, irodsTagValue);
	...
	@Test
	public final void testUpdateDescriptionDataObjectShouldAdd() throws Exception {
		...
		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.checkAndUpdateDescriptionOnDataObject(targetIrodsDataObject, irodsTagValue);
		...
		Assert.assertEquals("did not get same description", expectedAttribName, actualTagValue.getTagData());

	}

	@Test
	public final void testUpdateDescriptionDataObjectShouldUpdate() throws Exception {
		...
		irodsTagValue = new IRODSTagValue(expectedNewAttribName, irodsAccount.getUserName());
		...
		IRODSTagValue actualTagValue = irodsTaggingService
				.getDescriptionOnDataObjectForLoggedInUser(targetIrodsDataObject);
		Assert.assertNotNull("did not get tag value", actualTagValue);
		Assert.assertEquals("did not get same description", expectedNewAttribName, actualTagValue.getTagData());

	}

	@Test
	public final void testUpdateDescriptionDataObjectShouldDelete() throws Exception {
	...
	@Test
	public final void testUpdateDescriptionCollectionShouldAdd() throws Exception {
		...
		IRODSAccount irodsAccount = testingPropertiesHelper.buildIRODSAccountFromTestProperties(testingProperties);
		IRODSFile targetIrodsFile = irodsFileSystem.getIRODSFileFactory(irodsAccount)
				.instanceIRODSFile(targetIrodsDataObject);
		targetIrodsFile.mkdirs();
		...
		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.checkAndUpdateDescriptionOnCollection(targetIrodsDataObject, irodsTagValue);
		IRODSTagValue actualTagValue = irodsTaggingService
	...
	@Test
	public final void testUpdateDescriptionOnCollectionShouldUpdate() throws Exception {
		...
		irodsTaggingService.addDescriptionToCollection(targetIrodsDataObject, irodsTagValue);
		irodsTagValue = new IRODSTagValue(newAttribName, irodsAccount.getUserName());
		irodsTaggingService.checkAndUpdateDescriptionOnCollection(targetIrodsDataObject, irodsTagValue);
		IRODSTagValue actualTagValue = irodsTaggingService
				.getDescriptionOnCollectionForLoggedInUser(targetIrodsDataObject);
		Assert.assertNotNull("did not get tag value", actualTagValue);
		Assert.assertEquals("did not get same description", newAttribName, actualTagValue.getTagData());

	}

	@Test
	public final void testUpdateDescriptionOnCollectionShouldDelete() throws Exception {
	...
	public final void testRemoveDescriptionFromLiveDataObject() throws Exception {
		...
		IRODSTaggingService irodsTaggingService = IRODSTaggingServiceImpl
				.instance(irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		irodsTaggingService.addDescriptionToDataObject(targetIrodsDataObject, irodsTagValue);
		irodsTaggingService.deleteDescriptionFromDataObject(targetIrodsDataObject, irodsTagValue);
