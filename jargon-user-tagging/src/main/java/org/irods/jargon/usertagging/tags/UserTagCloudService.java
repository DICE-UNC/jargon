...
public interface UserTagCloudService {
	...
	/**
	 * Get the tag cloud for the logged-in user for data objects within iRODS.
	 * This will return a view of tags with 0 counts for collections, and counts
	 * for the data objects.
	 * 
	 * @return {@link org.irods.jargon.usertagging.domain.UserTagCloudView} with
	 *         the tag cloud for the domain.
	 * @throws JargonException
	 */
	public UserTagCloudView getTagCloudForDataObjects() throws JargonException;

	/**
	 * Get the tag cloud for the logged-in user for collections within iRODS.
	 * This will return a view of tags with 0 counts for data objects, and
	...
	/**
	 * Get the complete tag cloud for the logged-in user for collections and
	 * data objects in iRODS. This method is what should typically be called to
	 * create a tag cloud, though methods are available to limit the data to
	 * either data objects or collections.
	 * 
	 * @return {@link org.irods.jargon.usertagging.domain.UserTagCloudView} with
	 *         the tag cloud for the files and collections.
	 * @throws JargonException
	 */
	public UserTagCloudView getTagCloud() throws JargonException;

	/**
	 * Get a tag cloud for the logged-in user for collections and data objects
	 * in iRODS matching the given search term. The search will be a select
	 * 'LIKE %searchTerm%'.
	 * 
	 * @param tagSearchTerm
	 ...
	 * @return {@link org.irods.jargon.usertagging.domain.UserTagCloudView} with
	 *         the tag cloud for the files and collections matching the supplied
	 *         term.
	 * @throws JargonException
	 */
