...
/**
 * Represents a search on a set of tags, and includes both the originating query, and the result values.
 * 
...
public class TagQuerySearchResult {
	...
	/**
	 * Static initializer.
	 * @param searchTags <code>String</code> with the free tags used to search.
	 * @param queryResultEntries <code>List</code> of <code>CollectionAndDataObjectListingEntry</code> that 
	 * has the query results.
	 * @return instance of <code>TagQuerySearchResult</code>
	 * @throws JargonException
	 */
	public static TagQuerySearchResult instance(final String searchTags, final List<CollectionAndDataObjectListingEntry> queryResultEntries) throws JargonException {
	 ...
	 * @throws JargonException
	 */
	private TagQuerySearchResult(final String searchTags, final List<CollectionAndDataObjectListingEntry> queryResultEntries) throws JargonException {
	...
	/**
	 * Get the  objects that are in response to the 
	 * query.
	 * @return <code>List</code> of <code>CollectionAndDataObjectListingEntry</code>
	 */
	...
	public boolean equals(Object obj) {
		...
		return (this.searchTags.equals(otherSearchResult.getSearchTags()) && this.queryResultEntries == otherSearchResult.getQueryResultEntries());
	}
