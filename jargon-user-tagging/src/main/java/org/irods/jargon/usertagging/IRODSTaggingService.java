...
public interface IRODSTaggingService {
	 ...
	 * @param irodsTagValue
	 *            {@link orgirods.jargon.usertagging.domain.IRODSTagValue} with
	 *            the tag information to be removed, including user name.
	 * @throws JargonException
	 */
	...
	/**
	 * Add a tag to a collection in iRODS for the user. The user with the
	 ...
	 * @throws JargonException
	 *             if error in iRODS or the domain type is not supported.
	 */
	 ...
	 *             if error in iRODS or the domain type is not supported.
	 */
	IRODSTagValue getDescriptionBasedOnMetadataDomain(
			MetadataDomain metadataDomain, String domainUniqueName)
			throws DataNotFoundException, JargonException;
