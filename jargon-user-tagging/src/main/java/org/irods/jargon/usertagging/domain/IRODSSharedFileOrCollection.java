...
public class IRODSSharedFileOrCollection extends UserAnnotatedCatalogItem
	 ...
	 *            collection).
	 * @param shareName <code>String</code> with an alias, or name for the share
	 * @param shareOwner
	 *            <code>String</code> with the user name who owns the shared file or collection
	 *             @param shareOwnerZone
	 *            <code>String</code> with zone for the user name who owns the shared file or collection.  May be set blank to denote current zone
	 * @param shareUser
	 *            {@link ShareUser} with the user names and permissions
	 *             @param shareOwner <code>String</code> with the owner of the share, in name#zone format
	 * 
	 * @throws JargonException
	 */
	public IRODSSharedFileOrCollection(final MetadataDomain metadataDomain,
			final String domainUniqueName, final String shareName, final String shareOwner, final String shareOwnerZone,
			 final List<ShareUser> shareUsers)
			throws JargonException {
