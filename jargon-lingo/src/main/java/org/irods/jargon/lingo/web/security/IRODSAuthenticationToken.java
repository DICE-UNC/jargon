...
/**
 * IRODS specific implementation of a Spring Security <code>Authentication</code> interface that represents an authentication request for an IRODS
 * Principal.  In this case, the Principal is an <code>IRODSAccount</code>
...
public class IRODSAuthenticationToken implements Authentication {
	...
	public IRODSAuthenticationToken(IRODSAccount irodsAccount) {
