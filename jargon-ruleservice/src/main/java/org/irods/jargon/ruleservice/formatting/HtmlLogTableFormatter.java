...
public class HtmlLogTableFormatter {
	...
	/**
	 * Given an exception, print the stack trace as a formatted HTML table usable in
	 * bootsrap2
	 *
	 * @param exception
	...
	/**
	 * Given a set of log data (which is delimited by the carriage returns, and an
	 * optional caption, return a table in bootstrap2 format, which is a basic
	 * striped table representing the log data
	 *
	 * @param logData
	 *            {@code String} with the log data
	 * @param caption
	 *            {@code String} that is blank if not needed, that givs an optional
	 *            table caption
	 * @return {@code String} representing an HTML table for bootstrap2
	 */
	public static String formatAsBootstrap2Table(final String logData, final String caption) {
