...
public class JargonZipServiceImplTest {
	...
	public void testObtainBundleAsIrodsFileGivenPaths() throws Exception {
		...
		JargonZipService jargonZipService = new JargonZipServiceImpl(zipServiceConfiguration,
				irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount);
		List<String> paths = new ArrayList<String>();
		paths.add(irodsCollectionRootAbsolutePath + "/" + rootCollection);

		IRODSFile bundle = jargonZipService.obtainBundleAsIrodsFileGivenPaths(paths);
		Assert.assertTrue("did not return bundle", bundle.exists());

	}

	@Test
	public void testObtainBundleAsInputStreamWithAdditionalMetadataGivenPaths() throws Exception {
		...
		BundleStreamWrapper wrapper = jargonZipService.obtainBundleAsInputStreamWithAdditionalMetadataGivenPaths(paths);
		...
		Assert.assertFalse("missing name", wrapper.getBundleFileName().isEmpty());
	...
	public void testObtainBundleAsInputStreamGivenPaths() throws Exception {
		...
		InputStream bundle = jargonZipService.obtainBundleAsInputStreamGivenPaths(paths);
