...
public enum TicketModifyAddOrRemoveTypeEnum {
	...
	TICKET_MODIFY_USER("user"), TICKET_MODIFY_GROUP("group"), TICKET_MODIFY_HOST("host"), TICKET_MODIFY_UNKNOWN("unknown");
	...
	public static List<String> getTicketModifyAddOrRemoveTypeList() {
		...
		for (TicketModifyAddOrRemoveTypeEnum ticketModifyAddOrRemoveTypeEnum : TicketModifyAddOrRemoveTypeEnum.values()) {
