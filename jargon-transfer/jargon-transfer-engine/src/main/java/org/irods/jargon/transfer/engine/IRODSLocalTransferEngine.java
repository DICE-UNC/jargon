...
final class IRODSLocalTransferEngine implements TransferStatusCallbackListener {
     ...
     */
    public static IRODSLocalTransferEngine getInstance(final TransferManager transferManager,
    ...
    protected static IRODSLocalTransferEngine instance(final TransferManager transferManager,
