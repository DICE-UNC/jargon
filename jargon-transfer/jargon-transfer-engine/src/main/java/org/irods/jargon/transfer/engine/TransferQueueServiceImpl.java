...
/**
 * Manage the transfer queue and display of status of transfers. This thread-safe object is meant to be a singleton and
 * manages processing of a transfer queue on behalf of the <code>TransferManager</code>
 * 
...
public class TransferQueueServiceImpl implements TransferQueueService {
    ...
    private final Logger log = LoggerFactory.getLogger(TransferQueueServiceImpl.class);
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#dequeueTransfer()
	 */
    @Override
	public LocalIRODSTransfer dequeueTransfer() throws JargonException {
        ...
        try {
            ...
            List<LocalIRODSTransfer> localIRODSTransferList = localIRODSTransferDAO.findByTransferState(
                    TransferState.ENQUEUED, TransferState.PROCESSING, TransferState.PAUSED);
            if (localIRODSTransferList != null & localIRODSTransferList.size() > 0) {
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#enqueuePutTransfer(java.lang.String, java.lang.String, java.lang.String, org.irods.jargon.core.connection.IRODSAccount)
	 */
    @Override
	public LocalIRODSTransfer enqueuePutTransfer(final String localSourceAbsolutePath,
            final String targetIRODSAbsolutePath, final String targetResource, final IRODSAccount irodsAccount)
            throws JargonException {
        log.debug("entering enqueuePutTransfer()");

        if (localSourceAbsolutePath == null || localSourceAbsolutePath.isEmpty()) {
            throw new JargonException("localSourceAbsolutePath is null or empty");
        }

        if (targetIRODSAbsolutePath == null || targetIRODSAbsolutePath.isEmpty()) {
            throw new JargonException("targetIRODSAbsolutePath is null or empty");
        }

        if (targetResource == null) {
            throw new JargonException("targetResource is null, set as blank if not used");
        }
        ...
        log.info("enqueue put transfer from local source: {}", localSourceAbsolutePath);
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#enqueueGetTransfer(java.lang.String, java.lang.String, java.lang.String, org.irods.jargon.core.connection.IRODSAccount)
	 */
    @Override
	public LocalIRODSTransfer enqueueGetTransfer(final String irodsSourceAbsolutePath,
            final String targetLocalAbsolutePath, final String sourceResource, final IRODSAccount irodsAccount)
            throws JargonException {
        ...
        if (sourceResource == null) {
            throw new JargonException("sourceResource is null, set as blank if not used");
        }
        ...
        log.info("enqueue get transfer from irods source: {}", irodsSourceAbsolutePath);
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#markTransferAsErrorAndTerminate(org.irods.jargon.transfer.dao.domain.LocalIRODSTransfer, org.irods.jargon.transfer.engine.TransferManager)
	 */
    @Override
	public void markTransferAsErrorAndTerminate(final LocalIRODSTransfer localIRODSTransfer,
            final TransferManager transferManager) throws JargonException {
        markTransferAsErrorAndTerminate(localIRODSTransfer, null, transferManager);
    }

    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#markTransferAsErrorAndTerminate(org.irods.jargon.transfer.dao.domain.LocalIRODSTransfer, java.lang.Exception, org.irods.jargon.transfer.engine.TransferManager)
	 */
    @Override
	public void markTransferAsErrorAndTerminate(final LocalIRODSTransfer localIRODSTransfer,
            final Exception errorException, final TransferManager transferManager) throws JargonException {

        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            LocalIRODSTransfer mergedTransfer = localIRODSTransferDAO.findById(localIRODSTransfer.getId());
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#getLastNInQueue(int)
	 */
    @Override
	public List<LocalIRODSTransfer> getLastNInQueue(final int countOfEntriesToShow) throws JargonException {
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#getCurrentQueue()
	 */
    @Override
	public List<LocalIRODSTransfer> getCurrentQueue() throws JargonException {
        ...
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            List<LocalIRODSTransfer> localIRODSTransferList = localIRODSTransferDAO.findByTransferState(80,
                    TransferState.ENQUEUED, TransferState.PROCESSING, TransferState.PAUSED);
            return localIRODSTransferList;
        } catch (TransferDAOException e) {
            throw new JargonException(e);
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#getErrorQueue()
	 */
    @Override
	public List<LocalIRODSTransfer> getErrorQueue() throws JargonException {
        ...
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            List<LocalIRODSTransfer> localIRODSTransferList = localIRODSTransferDAO.findByTransferStatus(80,
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#getWarningQueue()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#showErrorTransfers()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#showWarningTransfers()
	 */
    @Override
	public List<LocalIRODSTransfer> showWarningTransfers() throws JargonException {
        return getWarningQueue();
    }

    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#getRecentQueue()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#purgeSuccessful()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#getAllTransferItemsForTransfer(java.lang.Long)
	 */
    @Override
	public List<LocalIRODSTransferItem> getAllTransferItemsForTransfer(final Long localIRODSTransferId)
        ...
        try {
            LocalIRODSTransferItemDAO localIRODSTransferItemDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferItemDAO();
            items = localIRODSTransferItemDAO.findAllItemsForTransferByTransferId(localIRODSTransferId);
        } catch (TransferDAOException e) {
            throw new JargonException(e);
        }
        return items;
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#getErrorTransferItemsForTransfer(java.lang.Long)
	 */
    @Override
	public List<LocalIRODSTransferItem> getErrorTransferItemsForTransfer(final Long localIRODSTransferId)
        ...
        try {
            LocalIRODSTransferItemDAO localIRODSTransferItemDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferItemDAO();
            items = localIRODSTransferItemDAO.findErrorItemsByTransferId(localIRODSTransferId);
        } catch (TransferDAOException e) {
            throw new JargonException(e);
        }
        return items;
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#restartTransfer(org.irods.jargon.transfer.dao.domain.LocalIRODSTransfer)
	 */
    @Override
	public void restartTransfer(final LocalIRODSTransfer localIRODSTransfer) throws JargonException {
        ...
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            LocalIRODSTransfer txfrToUpdate = localIRODSTransferDAO.findById(localIRODSTransfer.getId());
            log.info("beginning tx to store status of this transfer ");
            log.info(">>>>restart last successful path:{}", txfrToUpdate.getLastSuccessfulPath());
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#resubmitTransfer(org.irods.jargon.transfer.dao.domain.LocalIRODSTransfer)
	 */
    @Override
	public void resubmitTransfer(final LocalIRODSTransfer localIRODSTransfer) throws JargonException {
        ...
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            LocalIRODSTransfer txfrToUpdate = localIRODSTransferDAO.findInitializedById(localIRODSTransfer.getId());
            Set<LocalIRODSTransferItem> items = txfrToUpdate.getLocalIRODSTransferItems();
            ...
            txfrToUpdate.setLocalIRODSTransferItems(new HashSet<LocalIRODSTransferItem>());
            txfrToUpdate.setTransferStatus(TransferStatus.OK);
            txfrToUpdate.setTransferState(TransferState.ENQUEUED);
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#enqueueReplicateTransfer(java.lang.String, java.lang.String, org.irods.jargon.core.connection.IRODSAccount)
	 */
    @Override
	public LocalIRODSTransfer enqueueReplicateTransfer(final String irodsAbsolutePath, final String targetResource,
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#setTransferAsCancelled(org.irods.jargon.transfer.dao.domain.LocalIRODSTransfer)
	 */
    @Override
	public void setTransferAsCancelled(final LocalIRODSTransfer localIRODSTransfer) throws JargonException {
        ...
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            LocalIRODSTransfer txfrToCancel = localIRODSTransferDAO.findById(localIRODSTransfer.getId());
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#purgeQueueBasedOnDate(int)
	 */
    @Override
	public void purgeQueueBasedOnDate(final int retentionDays) throws JargonException {

        if (retentionDays < 0) {
            throw new JargonException("retentionDays must be 0 or greater");
        }

        log.info("purging the queue of all completed or cancelled items more than {} days old", retentionDays);
    ...
    /* (non-Javadoc)
	 * @see org.irods.jargon.transfer.engine.TransferQueueService#processQueueAtStartup()
	 */
    @Override
	public void processQueueAtStartup() throws JargonException {
        ...
        for (LocalIRODSTransfer localIrodsTransfer : currentQueue) {
            if (localIrodsTransfer.getTransferState().equals(TransferState.PROCESSING)) {
                log.info("resetting a processing transfer to enqueued:{}", localIrodsTransfer);
    ...
    /**
     * Reset a transfer to enqueued. Used on startup so transfers marked as processed are not treated as such during
     * dequeue.
     * 
     * @param transferToReset
     *            {@link org.irods.jargon.transfer.dao.domain.LocalIRODSTransfer} to be reset
     * @throws JargonException
     */
    private void resetTransferToEnqueued(final LocalIRODSTransfer transferToReset) throws JargonException {
