...
public class TransferQueueService {
    ...
    private final Logger log = LoggerFactory.getLogger(TransferQueueService.class);
     ...
     * @throws JargonException
     */
    public List<LocalIRODSTransfer> getLastNInQueue(int countOfEntriesToShow) throws JargonException {
        ...
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            List<LocalIRODSTransfer> localIRODSTransferList = localIRODSTransferDAO.findAllSortedDesc(80);
     ...
     * @throws JargonException
     */
    public List<LocalIRODSTransferItem> getAllTransferItemsForTransfer(Long localIRODSTransferId)
            throws JargonException {
        log.debug("entering getAllTransferItemsForTransfer(Long localIRODSTransferId)");
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            LocalIRODSTransfer localIRODSTransfer = localIRODSTransferDAO.findById(localIRODSTransferId);
            return new ArrayList<LocalIRODSTransferItem>(localIRODSTransfer.getLocalIRODSTransferItems());
        } catch (TransferDAOException e) {
            throw new JargonException(e);
        }
    }
    ...
    public List<LocalIRODSTransferItem> getErrorTransferItemsForTransfer(final Long localIRODSTransferId)
        ...
        try {
            LocalIRODSTransferDAO localIRODSTransferDAO = transferDAOMgr.getTransferDAOBean()
                    .getLocalIRODSTransferDAO();
            LocalIRODSTransfer localIRODSTransfer = localIRODSTransferDAO.findById(localIRODSTransferId, true);
            return new ArrayList<LocalIRODSTransferItem>(localIRODSTransfer.getLocalIRODSTransferItems());
        } catch (TransferDAOException e) {
            throw new JargonException(e);
        }
    ...
    public void resubmitTransfer(final LocalIRODSTransfer localIRODSTransfer) throws JargonException {
        ...
        try {
            ...
            localIRODSTransferItemDAO.delete(items.toArray(new LocalIRODSTransferItem[items.size()]));
