...
public interface TransferManagerCallbackListener {
    ...
    /**
     * Allows transfer managers to tap into the status callbacks coming from the iRODS transfer operation. This may be
     * per file updates, and in the future might be intra-file byte count updates as well.
     * 
     * @param transferStatus
     *            <code>TransferStatus</code> block with details of the current transfer.
     */
