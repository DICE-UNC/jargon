...
public class SynchronizeProcessorImplTest {
    ...
    public void testCreateInstanceWithAllPrereqs() throws Exception {
        FileTreeDiffUtility fileTreeDiffUtility = Mockito.mock(FileTreeDiffUtility.class);
    ...
    @Test(expected = IllegalStateException.class)
    public void testCreateInstanceWithNullIrodsAccessObjectFactory() throws Exception {
        FileTreeDiffUtility fileTreeDiffUtility = Mockito.mock(FileTreeDiffUtility.class);
    ...
    public void testScheduleAPutNullDiffModel() throws Exception {
        ...
        synchProcessor.setTransferManager(transferManager);
        synchProcessor.setFileTreeDiffUtility(fileTreeDiffUtility);
        synchProcessor.synchronizeLocalToIRODS("device", "/c1/c2", "test1/home/theperson", 0);
    }
    ...
    public void testScheduleWithALocalPlus() throws Exception {
        ...
        FileTreeDiffEntry fileTreeDiffEntry = FileTreeDiffEntry.instance(DiffType.DIRECTORY_NO_DIFF, collEntry);
        ...
        fileTreeDiffEntry = FileTreeDiffEntry.instance(DiffType.DIRECTORY_NO_DIFF, collEntry);
        ...
        fileTreeDiffEntry = FileTreeDiffEntry.instance(DiffType.LEFT_HAND_PLUS, collEntry);
        fileTreeNode.add(new FileTreeNode(fileTreeDiffEntry));

        Mockito.when(
                fileTreeDiffUtility.generateDiffLocalToIRODS((File) Mockito.any(), Mockito.anyString(),
        ...
        Mockito.verify(transferManager).enqueueAPut(localRoot + c2Name, irodsRoot + c2Name,
