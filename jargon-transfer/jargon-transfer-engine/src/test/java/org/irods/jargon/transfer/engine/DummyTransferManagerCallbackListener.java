 ...
 * 
 */
public class DummyTransferManagerCallbackListener implements TransferManagerCallbackListener {
     ...
     * (non-Javadoc)
     * 
     * @seeorg.irods.jargon.transferengine.TransferManagerCallbackListener# transferManagerErrorStatusUpdate
     ...
     * (non-Javadoc)
     * 
     * @seeorg.irods.jargon.transferengine.TransferManagerCallbackListener# transferManagerRunningStatusUpdate
     * (org.irods.jargon.transferengine.TransferManager.RunningStatus)
     */
    @Override
    public void transferManagerRunningStatusUpdate(final RunningStatus runningStatus) {
