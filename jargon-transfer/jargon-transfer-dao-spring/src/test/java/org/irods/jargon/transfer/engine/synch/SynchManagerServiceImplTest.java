...
import org.irods.jargon.transfer.dao.domain.SynchronizationMode;
...
public class SynchManagerServiceImplTest {
	...
	public void testCreateNewSynchConfiguration() throws Exception {
		SynchConfiguration synchConfiguration = new SynchConfiguration();
		...
		synchConfiguration
				.setSynchronizationMode(SynchronizationMode.ONE_WAY_LOCAL_TO_IRODS);
