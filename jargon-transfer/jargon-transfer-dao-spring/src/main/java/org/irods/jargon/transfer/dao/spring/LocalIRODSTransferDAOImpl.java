...
public class LocalIRODSTransferDAOImpl extends HibernateDaoSupport implements LocalIRODSTransferDAO {
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.LocalIRODSTransferDAO#save(org.irods.jargon
     * .transfer.dao.domain.LocalIRODSTransfer)
     */
    @Override
    public void save(final LocalIRODSTransfer localIRODSTransfer) throws TransferDAOException {
        logger.info("entering save(LocalIRODSTransfer)");
        this.getSessionFactory().getCurrentSession().saveOrUpdate(localIRODSTransfer);
    }
     ...
     */
    @Override
    public LocalIRODSTransfer findById(final Long id) throws TransferDAOException {
        logger.debug("entering findById(Long)");
        return (LocalIRODSTransfer) this.getSessionFactory().getCurrentSession().get(LocalIRODSTransfer.class, id);
    }
     ...
     */
    @Override
    public LocalIRODSTransfer findInitializedById(final Long id) throws TransferDAOException {
        logger.debug("entering findInitializedById(Long)");
        LocalIRODSTransfer localIrodsTransfer = (LocalIRODSTransfer) this.getSessionFactory().getCurrentSession()
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.LocalIRODSTransferDAO#findByTransferState
     * (org.irods.jargon.transfer.dao.domain.TransferState[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<LocalIRODSTransfer> findByTransferState(final TransferState... transferState)
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.LocalIRODSTransferDAO#findByTransferState (int,
     * org.irods.jargon.transfer.dao.domain.TransferState[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<LocalIRODSTransfer> findByTransferState(final int maxResults, final TransferState... transferState)
            throws TransferDAOException {
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.LocalIRODSTransferDAO#findByTransferStatus (int,
     * org.irods.jargon.transfer.dao.domain.TransferStatus[])
     */
    @SuppressWarnings("unchecked")
    @Override
    public List<LocalIRODSTransfer> findByTransferStatus(final int maxResults, final TransferStatus... transferStatus)
            throws TransferDAOException {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<LocalIRODSTransfer> findAllSortedDesc(final int maxResults) throws TransferDAOException {
    ...
    public void purgeQueue() throws TransferDAOException {
        ...
        try {
            ...
            int rows = hibernateTemplate.bulkUpdate(sb.toString(), TransferState.PROCESSING);
            ...
            rows = super.getHibernateTemplate().bulkUpdate(sb.toString(), TransferState.PROCESSING);
    ...
    public void purgeSuccessful() throws TransferDAOException {
        ...
        try {
            ...
            int rows = super.getHibernateTemplate().bulkUpdate(sb.toString(),
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.LocalIRODSTransferDAO#delete(org.irods.
