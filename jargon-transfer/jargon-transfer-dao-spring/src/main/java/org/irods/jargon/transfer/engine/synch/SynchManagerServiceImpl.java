...
public class SynchManagerServiceImpl implements SynchManagerService {
	...
	public void setSynchConfigurationDAO(
			final SynchConfigurationDAO synchConfigurationDAO) {
	...
	public void createNewSynchConfiguration(
			final SynchConfiguration synchConfiguration) throws SynchException {
