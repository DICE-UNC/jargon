...
/**
 * Service to manage configuration information for transfer engine. The configuration is maintained as key/value pair
 * properties. As such, it is intended that clients that are built on top of the transfer engine library can utilize
 * this for application specific configuration storage.
 * 
...
public class ConfigurationServiceImpl implements ConfigurationService {
     ...
     */
    public void setConfigurationPropertyDAO(final ConfigurationPropertyDAO configurationPropertyDAO) {
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.engine.ConfigurationService# listConfigurationProperties()
     */
    @Override
    @Transactional
    public List<ConfigurationProperty> listConfigurationProperties() throws TransferEngineException {
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.engine.ConfigurationService# deleteConfigurationProperty
     * (org.irods.jargon.transfer.dao.domain.ConfigurationProperty)
     */
    @Override
    @Transactional
    public void deleteConfigurationProperty(final ConfigurationProperty configurationProperty)
        ...
        log.info("deleteConfigurationProperty(ConfigurationProperty) with: {}", configurationProperty);
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.engine.ConfigurationService# addConfigurationProperty
     * (org.irods.jargon.transfer.dao.domain.ConfigurationProperty)
     */
    @Override
    @Transactional
    public ConfigurationProperty addConfigurationProperty(final ConfigurationProperty configurationProperty)
            throws TransferEngineException {
        ...
        log.info("addConfigurationProperty(ConfigurationProperty) with: {}", configurationProperty);
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.engine.ConfigurationService# updateConfigurationProperty
     * (org.irods.jargon.transfer.dao.domain.ConfigurationProperty)
     */
    @Override
    @Transactional
    public void updateConfigurationProperty(final ConfigurationProperty configurationProperty)
            throws TransferEngineException {
        ...
        log.info("updateConfigurationProperty(ConfigurationProperty) with: {}", configurationProperty);
