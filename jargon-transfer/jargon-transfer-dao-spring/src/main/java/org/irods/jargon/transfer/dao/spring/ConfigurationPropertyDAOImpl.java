...
public class ConfigurationPropertyDAOImpl extends HibernateDaoSupport implements ConfigurationPropertyDAO {
    ...
    private static final Logger log = LoggerFactory.getLogger(ConfigurationPropertyDAOImpl.class);

    /*
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.ConfigurationPropertyDAO#saveOrUpdate(org
     * .irods.jargon.transfer.dao.domain.ConfigurationProperty)
     */
    @Override
    public void saveOrUpdate(final ConfigurationProperty configurationProperty) throws TransferDAOException {
        log.info("entering save(ConfigurationProperty)");

        this.getSessionFactory().getCurrentSession().saveOrUpdate(configurationProperty);
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.ConfigurationPropertyDAO#findById(java. lang.Long)
     */
    @Override
    public ConfigurationProperty findById(final Long id) throws TransferDAOException {
        log.info("entering findById with id:{}", id);
        return (ConfigurationProperty) this.getSessionFactory().getCurrentSession()
    ...
    public List<ConfigurationProperty> findAll() throws TransferDAOException {
        Criteria criteria = this.getSessionFactory().getCurrentSession().createCriteria(ConfigurationProperty.class);
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.ConfigurationPropertyDAO#delete(org.irods
     * .jargon.transfer.dao.domain.ConfigurationProperty)
     */
    @Override
    public void delete(final ConfigurationProperty configurationProperty) throws TransferDAOException {
        try {

            this.getSessionFactory().getCurrentSession().delete(configurationProperty);
            ...
            throw new TransferDAOException("Failed delete(ConfigurationProperty)", e);
        }
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.transfer.dao.ConfigurationPropertyDAO#deleteAllProperties ()
     */
    @Override
