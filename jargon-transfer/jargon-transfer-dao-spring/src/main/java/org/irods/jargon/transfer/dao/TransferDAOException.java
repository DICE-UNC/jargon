...
public class TransferDAOException extends JargonException {
    ...
    public TransferDAOException(final String message, final int underlyingIRODSExceptionCode) {
        super(message, underlyingIRODSExceptionCode);
    }

    public TransferDAOException(final String message, final Throwable cause, final int underlyingIRODSExceptionCode) {
    ...
    public TransferDAOException(final Throwable cause, final int underlyingIRODSExceptionCode) {
