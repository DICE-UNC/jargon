...
/**
 * Interface that describes the service layer for managing configuration information for transfer engine, and any
 * application built on top of transfer engine. The configuration information is stored as key/value pairs.
 * 
...
public interface ConfigurationService {
     ...
     */
    List<ConfigurationProperty> listConfigurationProperties() throws TransferEngineException;
     ...
     * 
     * @param configurationProperty
     *            {@link ConfigurationProperty} that will be updated in the store
     * @throws TransferEngineException
     */
    void updateConfigurationProperty(ConfigurationProperty configurationProperty) throws TransferEngineException;

    /**
     * Delete the given property from the config store.
     * 
     * @param configurationProperty
     *            {@link ConfigurationProperty} that will be deleted from the store
     * @throws TransferEngineException
     */
     ...
     * @throws TransferEngineException
     */
    void importProperties(Properties propertiesToImport) throws TransferEngineException;
