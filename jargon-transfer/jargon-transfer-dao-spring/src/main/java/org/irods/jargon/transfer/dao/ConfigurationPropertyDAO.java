...
/**
 * DAO-style interface for managing KVP configuration properties for the transfer engine. This is a generic property
 * store that can also be used on apps built on top of transfer engine. Care should be taken to namespace define key
 * names in case multiple apps desire to share this property store.
 * 
...
public interface ConfigurationPropertyDAO {
    ...
    /**
     * Save the property to the store. Note that the key of the key/value pair is a unique database value, so that
     * duplicate properties cannot be added
     * 
     * @param configurationProperty
     *            {@link ConfigurationProperty} that represents an entry of a configuration value in the database.
     * @throws TransferDAOException
     */
    void saveOrUpdate(ConfigurationProperty configurationProperty) throws TransferDAOException;
     ...
     * 
     * @return <code>List</code> of {@link ConfigurationProperty} representing the configuration properties store as
     *         key/value pairs
     * @throws TransferDAOException
     */
     ...
     * @throws TransferDAOException
     */
    void delete(ConfigurationProperty configurationProperty) throws TransferDAOException;
