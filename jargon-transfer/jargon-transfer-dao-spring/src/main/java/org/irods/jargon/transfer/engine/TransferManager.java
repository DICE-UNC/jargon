...
public interface TransferManager {
    ...
    /**
     * Get the error status of the queue. The error status reflects the current or last transfer, and will be overridden
     ...
     *            <code>String</code> with the absolute path to the local file to be transferred to iRODS
     * @param targetAbsolutePath
     *            <code>String</code> with the absolute path to the target file in iRODS
     * @param resource
     *            <code>String</code> with the optional resource to specifiy as the transfer target
     * @param irodsAccount
     *            <code>IRODSAccount</code> that describes the target iRODS and user identity
     * @throws JargonException
     */
    void enqueueAPut(final String sourceAbsolutePath, final String targetAbsolutePath, final String resource,
     ...
     * 
     * @param sourceAbsolutePath
     *            <code>String</code> with the absolute path to the iRODS file to be transferred to the local file
     *            system
     * @param targetAbsolutePath
     *            <code>String</code> with the absolute path to the target file in the local file system
     * @param resource
     *            <code>String</code> with the optional resource to specifiy as the transfer target
     * @param irodsAccount
     *            <code>IRODSAccount</code> that describes the target iRODS and user identity
     * @throws JargonException
     */
    void enqueueAGet(final String irodsSourceAbsolutePath, final String targetLocalAbsolutePath, final String resource,
            final IRODSAccount irodsAccount) throws JargonException;
     ...
     *            <code>String</code> with the iRODS file to replicate by absolute path
     * @param targetResource
     *            <code>String</code> with the resource to which the file will replicat
     * @param irodsAccount
     *            <code>IRODSAccount</code> describing the user and zone
     * @throws JargonException
     */
    void enqueueAReplicate(final String irodsAbsolutePath, final String targetResource, final IRODSAccount irodsAccount)
            throws JargonException;
     ...
     *            <code>String</code> with the source collection or data object
     * @param targetResource
     *            <code>String<code> with the resource to which the file should be copied
     * @param irodsTargetAbsolutePath
     *            <code>String</code> with the absolute path to the target of the copy
     * @param irodsAccount
     *            {@link IRODSAccount} with the connection information for the given zone
     * @throws JargonException
     */
