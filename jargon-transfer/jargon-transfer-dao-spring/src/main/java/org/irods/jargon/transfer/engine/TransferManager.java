...
public interface TransferManager {
	...
	/**
	 * Get the error status of the queue. The error status reflects the current
	 * or last transfer, and will be overridden when the queue is restarted.
	 * 
	 ...
	 *            to be transferred to the local file system
	 * @param targetAbsolutePath
	 *            <code>String</code> with the absolute path to the target file
	 ...
	 *            <code>String</code> with the iRODS file to replicate by
	 *            absolute path
	 ...
	 * using the normal transfer engine.
	 * 
	 * @param synchronization
	 *            {@link Synchronization} that describes the configuration
	 *            information
	 * @param irodsAccount
