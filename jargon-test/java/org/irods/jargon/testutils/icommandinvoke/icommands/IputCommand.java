...
/**
 * Build an iput command using the given properties for invocation by an
 * IcommandInvoker
 * 
...
public class IputCommand implements Icommand {
	...
	public List<String> buildCommand() throws IcommandException {
		if (localFileName.length() <= 0) {
			throw new IcommandException(
					"no local file name provided for the iput command");
		}
	...
	/**
	 * Flag indicating whether to force override of a file if file exists
	 * already
	 * 
