...
/**
 * Test of an invoker that will inspect a given file tree to create a summary
 * 
 * @author Mike Conway - DICE
 * 
 */
public class FileTreeIteratorVisitorInvokerTest {

	private static Properties testingProperties = new Properties();
	private static JargonProperties jargonOriginalProperties = null;
	private static org.irods.jargon.testutils.TestingPropertiesHelper testingPropertiesHelper = new TestingPropertiesHelper();
	private static org.irods.jargon.testutils.filemanip.ScratchFileUtils scratchFileUtils = null;
	public static final String IRODS_TEST_SUBDIR_PATH = "FileTreeIteratorVisitorInvokerTest";
	...
	public void testLocalTreeVisitor() throws Exception {
		...
		FileTreeIteratorVisitorInvoker invoker = new FileTreeIteratorVisitorInvoker(
				...
				fileTreeIteratorVisitor, localFile);
	...
	public void testIrodsTreeVisitor() throws Exception {
		...
		FileTreeIteratorVisitorInvoker invoker = new FileTreeIteratorVisitorInvoker(
				irodsFileSystem.getIRODSAccessObjectFactory(), irodsAccount,
				fileTreeIteratorVisitor, (File) destFile);
