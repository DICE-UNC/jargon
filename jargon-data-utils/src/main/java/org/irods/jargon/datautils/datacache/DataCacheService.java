...
public interface DataCacheService {
	...
	/**
	 * Given a {@code String} value, and a key value, encrypt the value by the
	 * key, and store the data in the appropriate iRODS file. This will be
	 * determined by the given {@link CacheServiceConfiguration}.
	 *
	 * @param stringToCache
	 *            {@code String} with the data to be cached
	 * @param key
	 *            {@code String} with the key that will be used to encrypt the
	 *            data
