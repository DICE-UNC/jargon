...
/**
 * Factory for various services that support image processing for iRODS applications
 * 
...
public interface ImageServiceFactory {
	...
	/**
	 * Retrieve an instance of <code>ImageServiceFactory</code> that supports image processing for iRODS
