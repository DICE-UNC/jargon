 ...
 * <p/>
 * This interface expects the availabilty of the rollup of hierarchical AVU
...
public interface IndexerFilterInterface {
	 ...
	 * 
	 * @param node
	 *            {@link HierComposite} that is a visitable directory
	 ...
	 * 
	 * @param leafNode
	 *            {@link HierLeaf} with the visted node
	 * @param metadataRollup
	 *            {@link MetadataRollup} with a stack of AVUs up to a parent
	 * @return {@link boolean} of <code>true</code> if it should be indexed
	 */
