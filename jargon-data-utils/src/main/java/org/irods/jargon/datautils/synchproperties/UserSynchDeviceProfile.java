...
/**
 * Describes the synchronization profile for a device (like a laptop, workstation, or other device) for a user.
 * 
...
public class UserSynchDeviceProfile {
    ...
    /**
     * A map (by iRODS absolute path to the root collection of the synch) of synch folders on iRODS.
     */
