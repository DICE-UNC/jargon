...
public class SynchPropertiesServiceImpl extends AbstractDataUtilsService implements SynchPropertiesService {
     ...
     * in synch root dir
     * 
     * [user name]:[device] | [lastLocalSynch | lastIrodsSynch | localAbsPath] | iRODSSynch:userSynchDir
     */
     ...
     */
    @Override
    public List<UserSynchTarget> getUserSynchTargets(final String userName) throws DataNotFoundException,
            JargonException {
