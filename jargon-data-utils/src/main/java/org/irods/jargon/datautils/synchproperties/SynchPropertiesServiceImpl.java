...
/**
 * Service to maintain synchronization properties for client->iRODS data synchronization
 * 
...
public class SynchPropertiesServiceImpl implements SynchPropertiesService {
     ...
     * in synch root dir
     * 
     * [device name]:[user name] | [lastLocalSynch | lastIrodsSynch | localAbsPath] | iRODSSynch:userSynchDir
     */
     ...
     *            <code>IRODSAccessObjectFactory</code> that can create various access objects to interact with iRODS
     * @param irodsAccount
     *            <code>IRODSAccount</code> that describes the user and server to connect to
     */
     ...
     * getUserSynchTargetForUserAndAbsolutePath(java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public UserSynchTarget getUserSynchTargetForUserAndAbsolutePath(final String userName, final String deviceName,
        ...
        if (valueComponents.length != 3) {
            log.error("did not find 3 expected values in the avu value: {}", deviceInfo);
        ...
        try {
            ...
            log.error("unable to parse out timestamps from synch data in AVU value:{}", deviceInfo);
     ...
     * 
     * @see
     * org.irods.jargon.datautils.synchproperties.SynchPropertiesService#updateTimestampsToCurrent(java.lang.String,
     * java.lang.String, java.lang.String)
     */
    @Override
    public void updateTimestampsToCurrent(final String userName, final String deviceName, final String irodsAbsolutePath)
     ...
     * addSynchDeviceForUserAndIrodsAbsolutePath(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public void addSynchDeviceForUserAndIrodsAbsolutePath(final String userName, final String deviceName,
        ...
        IRODSFile irodsCollection = irodsAccessObjectFactory.getIRODSFileFactory(irodsAccount).instanceIRODSFile(
                irodsAbsolutePath);
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.datautils.synchproperties.SynchPropertiesService#synchDeviceExists(java.lang.String,
     * java.lang.String, java.lang.String)
     */
    @Override
    public boolean synchDeviceExists(String userName, String deviceName, String irodsAbsolutePath)
            throws JargonException {
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.datautils.synchproperties.SynchPropertiesService#removeSynchDevice(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.irods.jargon.datautils.synchproperties.SynchPropertiesService# getSynchTimestamps()
     */
    @Override
