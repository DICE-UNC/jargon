...
public interface SynchPropertiesService {
	 ...
	 * @param userName <code>String</code> with the user name that will synch for the given device
	 * @param deviceName <code>String</code> with a device name that represents the local file system that will synchronize to iRODS
	 * @param irodsAbsolutePath <code>String</code> with the absolute path to an iRODS collection that will be synchronized with the given local collection
	 * @param localAbsolutePath <code>String</code> with the absolute path to the local file system directory that will be synched to iRODS
	 * @throws DuplicateDataException <code>String</code> that indicates that this synch has already been configured
	 * @throws JargonException
	 */
	void addSynchDeviceForUserAndIrodsAbsolutePath(
			final String userName, final String deviceName, final String irodsAbsolutePath, final String localAbsolutePath)
