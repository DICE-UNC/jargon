...
public class ModAccessControlInpTest {
	...
	public void testInstanceGoodNoZone() throws Exception {
		ModAccessControlInp pi = ModAccessControlInp.instanceForSetPermission(true, "", "path", "userName", "own");
		...
		Assert.assertEquals(ModAccessControlInp.MOD_ACESS_CONTROL_API_NBR, pi.getApiNumber());
	}
	...
	public void testInstanceNullZone() throws Exception {
		ModAccessControlInp.instanceForSetPermission(true, null, "path", "userName", "write");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testInstanceBlankPath() throws Exception {
		ModAccessControlInp.instanceForSetPermission(true, "zone", "", "userName", "read");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testInstanceNullPath() throws Exception {
		ModAccessControlInp.instanceForSetPermission(true, "zone", null, "userName", "read");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testInstanceBlankUser() throws Exception {
		ModAccessControlInp.instanceForSetPermission(true, "zone", "path", "", "read");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testInstanceNullUser() throws Exception {
		ModAccessControlInp.instanceForSetPermission(true, "zone", "path", null, "read");
	}
	...
	public void testInstanceNullPermission() throws Exception {
		ModAccessControlInp.instanceForSetPermission(true, "zone", "path", "user", null);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testInstanceInvalidPermission() throws Exception {
		ModAccessControlInp.instanceForSetPermission(true, "zone", "path", "user", "nope");
	}

	@Test
	public final void testGetParsedTags() throws Exception {
		ModAccessControlInp pi = ModAccessControlInp.instanceForSetPermission(true, "", "path", "userName", "read");
		...
		Assert.assertEquals("invalid packing instruction", sb.toString(), actualTags);
	}

	@Test
	public final void testGetParsedTagsAdminMode() throws Exception {
		ModAccessControlInp pi = ModAccessControlInp.instanceForSetPermissionInAdminMode(true, "", "path", "userName",
				"read");
		String actualTags = pi.getParsedTags();
