...
public class DataObjInpTest {
	...
	public final void testInstanceForPut() throws Exception {
		DataObjInp dataObjInp = DataObjInp.instanceForInitialCallToPut("/abspath", 100, "aresource", true); 
		TestCase.assertNotNull("data obj inp returned was null", dataObjInp);
	...
	public final void testGetParsedTagsForInitialCallToPut() throws Exception {
		DataObjInp dataObjInp = DataObjInp.instanceForInitialCallToPut("/test1/home/test1/test-scratch/IrodsCommandsPutTest/testPutOverwriteFileNotInIRODS.txt", 716800000, "test1-resc", false);
	...
	public final void testGetParsedTagsForCallToPutNormalMode() throws Exception {
		DataObjInp dataObjInp = DataObjInp.instanceForNormalPutStrategy("/test1/home/test1/test-scratch/IrodsCommandsPutTest/testPutOverwriteFileNotInIRODS.txt", 1, "test1-resc", true);
