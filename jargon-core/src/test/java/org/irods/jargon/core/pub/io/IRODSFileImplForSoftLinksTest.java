...
public class IRODSFileImplForSoftLinksTest {
	...
	/**
	 * Inquire on canRead on a data object when it is set on the canonical path, and
	 * queried on the soft linked path
	 */
	@Test
	public final void testCanReadWhenSoftLinked() throws Exception {
		...
		Assert.assertTrue("cannot read the permissions using the soft linked path",
				irodsFileForSecondaryUser.canRead());
	}

	/**
	 * Inquire on exists on a data object when it is set on the canonical path, and
	 * queried on the soft linked path
	 */
	@Test
	 ...
	 */
	@Test
	public final void testCreateAndThenListADataObjectUnderASoftLinkedCollection() throws Exception {
	 ...
	 */
	@Test
	public final void testMkdirAndListUnderParentUnderASoftLinkedCollection() throws Exception {
