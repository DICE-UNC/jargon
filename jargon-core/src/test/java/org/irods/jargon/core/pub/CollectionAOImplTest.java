...
public class CollectionAOImplTest {
    ...
    public void testFindAll() throws Exception {
        ...
        List<Collection> collections = collectionAO.findAll("/"
                + testingProperties.getProperty(TestingPropertiesHelper.IRODS_ZONE_KEY) + "/home");
    ...
    public void testFindAllPartialStart() throws Exception {
        ...
        List<Collection> moreCollections = collectionAO.findAll(
                "/" + testingProperties.getProperty(TestingPropertiesHelper.IRODS_ZONE_KEY) + "/home", partialStart);

        Assert.assertEquals("did not find right collection at partial start", collections.get(partialStart)
                .getCollectionId(), moreCollections.get(0).getCollectionId());
        Assert.assertNotNull(collections);
        Assert.assertFalse(collections.isEmpty());
    ...
    public void testMkdirThenAddAvuMetadataWithColonInArg() throws Exception {
        ...
        IRODSAccount irodsAccount = testingPropertiesHelper.buildIRODSAccountFromTestProperties(testingProperties);
        IRODSFile dirFile = irodsFileSystem.getIRODSFileFactory(irodsAccount).instanceIRODSFile(
                targetIrodsCollection + "/" + subdir);
        dirFile.mkdirs();
        ...
        List<MetaDataAndDomainData> actualMetadata = collectionAO.findMetadataValuesForCollection(dirFile
                .getAbsolutePath());
    ...
    public void testRemoveAvuMetadata() throws Exception {
        ...
        IRODSAccessObjectFactory accessObjectFactory = irodsFileSystem.getIRODSAccessObjectFactory();
        CollectionAO collectionAO = accessObjectFactory.getCollectionAO(irodsAccount);
        IRODSFile targetCollectionAsFile = irodsFileSystem.getIRODSFileFactory(irodsAccount).instanceIRODSFile(
                targetIrodsCollection);
    ...
    public void testRewriteAvuMetadata() throws Exception {
        ...
        String metaValues = invoker.invokeCommandAndGetResultAsString(imetaList);
        Assert.assertTrue("did not find expected attrib name", metaValues.indexOf(expectedAttribName) > -1);
        Assert.assertTrue("did not find expected attrib value", metaValues.indexOf(expectedNewAttribValue) > -1);
    }

    @Test
    public final void findMetadataValuesByMetadataQueryWithAdditionalWhereCollectionLike() throws Exception {
        ...
        imkdirCommand.setCollectionName(targetIrodsCollection + "/" + testSubdir1);
        invoker.invokeCommandAndGetResultAsString(imkdirCommand);

        imkdirCommand = new ImkdirCommand();
        imkdirCommand.setCollectionName(targetIrodsCollection + "/" + testSubdir2);
        invoker.invokeCommandAndGetResultAsString(imkdirCommand);
        ...
        imetaRemoveCommand.setAttribUnits(expectedAttribUnits);
        imetaRemoveCommand.setMetaObjectType(MetaObjectType.COLLECTION_META);
        imetaRemoveCommand.setObjectPath(targetIrodsCollection + "/" + testSubdir1);
        invoker.invokeCommandAndGetResultAsString(imetaRemoveCommand);
        imetaRemoveCommand.setObjectPath(targetIrodsCollection + "/" + testSubdir2);
        invoker.invokeCommandAndGetResultAsString(imetaRemoveCommand);
        ...
        imetaAddCommand.setAttribValue(expectedAttribValue);
        imetaAddCommand.setAttribUnits(expectedAttribUnits);
        imetaAddCommand.setObjectPath(targetIrodsCollection + "/" + testSubdir1);
        invoker.invokeCommandAndGetResultAsString(imetaAddCommand);
        imetaAddCommand.setObjectPath(targetIrodsCollection + "/" + testSubdir2);
        invoker.invokeCommandAndGetResultAsString(imetaAddCommand);
        ...
        List<MetaDataAndDomainData> queryResults = collectionAO.findMetadataValuesByMetadataQueryWithAdditionalWhere(
    ...
    public final void findMetadataValuesForCollection() throws Exception {
        ...
        List<MetaDataAndDomainData> queryResults = collectionAO.findMetadataValuesForCollection(targetIrodsCollection
                + "/" + testSubdir1, 0);
    ...
    public void findByAbsolutePath() throws Exception {
        ...
        TestCase.assertNotNull("did not find the collection, was null", collection);
    }
    ...
    public void testFindDomainByMetadataQueryWithTwoAVUQueryElements() throws Exception {
        ...
        EnvironmentalInfoAO environmentalInfoAO = irodsFileSystem.getIRODSAccessObjectFactory().getEnvironmentalInfoAO(
                irodsAccount);
        ...
        IRODSFile testCollection = irodsFileSystem.getIRODSFileFactory(irodsAccount).instanceIRODSFile(
                targetIrodsCollection);
        ...
        queryElements.add(AVUQueryElement.instanceForValueQuery(AVUQueryElement.AVUQueryPart.VALUE,
                AVUQueryOperatorEnum.EQUAL, expectedAttribValue2));
    ...
    public final void testSetRead() throws Exception {
        ...
        IRODSFile irodsFileForSecondaryUser = irodsFileSystem.getIRODSFileFactory(secondaryAccount).instanceIRODSFile(
                targetIrodsCollection);
    ...
    public final void testSetOwn() throws Exception {
        ...
        IRODSFile irodsFileForSecondaryUser = irodsFileSystem.getIRODSFileFactory(secondaryAccount).instanceIRODSFile(
                targetIrodsCollection);
        IRODSFileSystemAO irodsFileSystemAO = irodsFileSystem.getIRODSAccessObjectFactory().getIRODSFileSystemAO(
                secondaryAccount);
    ...
    public final void testGetFilePermissionForOwn() throws Exception {
        ...
        IRODSAccount secondaryAccount = testingPropertiesHelper
                .buildIRODSAccountFromSecondaryTestProperties(testingProperties);
        CollectionAO collectionAOSecondary = irodsFileSystem.getIRODSAccessObjectFactory().getCollectionAO(
                secondaryAccount);
        FilePermissionEnum enumVal = collectionAOSecondary.getPermissionForCollection(targetIrodsCollection,
                secondaryAccount.getUserName(), "");

        TestCase.assertEquals("should have found own permissions", FilePermissionEnum.OWN, enumVal);
    ...
    public final void testGetFilePermissionForOtherUserWhoHasRead() throws Exception {
        ...
        TestCase.assertEquals("should have found read permissions", FilePermissionEnum.READ, enumVal);
    ...
    public final void testSetNoInherit() throws Exception {
        ...
        TestCase.assertFalse("collection should have inherit turned back off", isInherit);
    ...
    public final void testGetPermissionsForCollectionForUser() throws Exception {
        ...
        TestCase.assertEquals("userName did not match expected",
                testingProperties.getProperty(TestingPropertiesHelper.IRODS_SECONDARY_USER_KEY),
