...
public class DataObjectAOImplTest {
	...
	public void testFindByAbsolutePathPercentInNameBug190() throws Exception {
		...
		IRODSFile parentDir = accessObjectFactory.getIRODSFileFactory(
				irodsAccount).instanceIRODSFile(targetIrodsFileParentPath);
		parentDir.mkdirs();
	...
	public final void testVerifyChecksum() throws Exception {
		...
		Assert.assertTrue("checksums do not match", dataObjectAO
				.verifyChecksumBetweenLocalAndIrods(testFile, localFile));
	}
	...
	public void testGetListingEntryForAbsolutePath() throws Exception {
		...
		ObjStat objStat = dataObjectAO.retrieveObjStat(destFile
				.getAbsolutePath());
	...
	public final void testIsUserHasAccessNullFileName() throws Exception {
		...
		IRODSAccount irodsAccount = testingPropertiesHelper
				.buildIRODSAccountFromTestProperties(testingProperties);
		FileCatalogObjectAO dataObjectAO = irodsFileSystem
				.getIRODSAccessObjectFactory().getDataObjectAO(irodsAccount);
