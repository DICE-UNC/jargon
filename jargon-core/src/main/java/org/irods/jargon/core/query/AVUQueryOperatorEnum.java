...
public enum AVUQueryOperatorEnum {
	EQUAL("=", 0, OperatorClass.VALUE), NOT_EQUAL("!=", 1, OperatorClass.VALUE), LESS_THAN("<", 2,
			OperatorClass.VALUE), GREATER_THAN(">", 3, OperatorClass.VALUE), LESS_OR_EQUAL("<=", 4,
					OperatorClass.VALUE), GREATER_OR_EQUAL(">=", 5, OperatorClass.VALUE), NUM_LESS_THAN("<", 15,
							OperatorClass.VALUE), NUM_LESS_OR_EQUAL("<=", 17,
									OperatorClass.VALUE), NUM_GREATER_OR_EQUAL(">=", 18, OperatorClass.VALUE), IN("IN",
											6, OperatorClass.VALUE_IN_ARRAY), NOT_IN("NOT_IN", 7,
													OperatorClass.VALUE_IN_ARRAY), BETWEEN("BETWEEN", 8,
															OperatorClass.VALUE_RANGE), NOT_BETWEEN("NOT_BETWEEN", 9,
																	OperatorClass.VALUE_RANGE), LIKE("LIKE", 10,
																			OperatorClass.VALUE), NOT_LIKE("NOT_LIKE",
																					11,
