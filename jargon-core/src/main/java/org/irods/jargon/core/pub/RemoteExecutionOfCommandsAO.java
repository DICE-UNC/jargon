...
public interface RemoteExecutionOfCommandsAO extends IRODSAccessObject {
	 ...
	 *            {@code String} with the command name. Do not provide input
	 *            arguments here.
	...
	/**
	 * Execute a script remotely. Use the provided iRODS absolute path to calculate
	 * the physical path to the file, and then provide that physical path as a
	 * command argument to the target script.
	 * <p>
	...
	/**
	 * Execute a script remotely. Use the provided iRODS absolute path to determine
	 * the server upon which the command will be run
	 * <p>
	 * This corresponds to the -p option of the iexec command.
	 *
	 * @param commandToExecuteWithoutArguments
	...
	InputStream executeARemoteCommandAndGetStreamUsingAnIRODSFileAbsPathToDetermineHost(
			...
			String absolutePathOfIrodsFileThatWillBeUsedToFindHostToExecuteOn) throws JargonException;
