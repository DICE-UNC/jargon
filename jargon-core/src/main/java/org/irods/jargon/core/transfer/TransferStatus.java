...
public class TransferStatus {
	...
	public enum TransferState {
		IN_PROGRESS_START_FILE, IN_PROGRESS_COMPLETE_FILE, SUCCESS, FAILURE, PAUSED, CANCELLED, RESTARTING, OVERALL_INITIATION, OVERALL_COMPLETION, SYNCH_INITIALIZATION, SYNCH_DIFF_GENERATION, SYNCH_DIFF_RESOLVE_STEP, SYNCH_COMPLETION
	}
