...
class ResourceAOHelper extends AOHelper {
	 ...
	 *
	 * @return {@code String} with a select statement to get resource data
	...
	/**
	 * From a result set for a resource query, build the {@code Resource}
	 * domain objects.
	 *
	 * @param resultSet
	 *            {@link IRODSQueryResultSetInterface} with a gen query result
	 * @return {@code List} of {@link Resource}, which will be empty if no
	 *         results
	 * @throws JargonException
	 */
	 ...
	 * {@code buildResourceSelectsComposable()}, create
	 * {@code Resource} objects that represent the results
	 *
	 * @param resultSet
	 * @return
	 * @throws JargonException
