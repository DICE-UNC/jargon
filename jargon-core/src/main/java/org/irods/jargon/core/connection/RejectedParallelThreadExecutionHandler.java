...
public class RejectedParallelThreadExecutionHandler implements RejectedExecutionHandler {
	...
	public void rejectedExecution(final Runnable arg0, final ThreadPoolExecutor arg1) {
		log.error(
				"parallel transfer thread execution failed due to lack of threads in the transfer queue, please adjust the parameters in jargon.properties to increase the cap on the pool");
