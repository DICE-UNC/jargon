...
public class DataObject extends IRODSDomainObject {
	 ...
	 * {@code DataObjectAO} class, and setting it outside of internal
	 ...
	 * collection. This is set by the {@code DataObjectAO} when retrieving
	 ...
	 * data object from the {@code DataObjectAO} class, and setting it
	 * outside of internal routines that build the data object from iCAT values
	 * has no meaning.
	 *
	 * @param collectionId
	 *            {@code int} with the unique id of the parent collection
	 *            from the iRODS ICAT.
	 */
	 ...
	 *
	 * @param dataName
	 *            {@code String} set by the {@code DataObjectAO} when
	 ...
	 *
	 * @param dataSize
	 *            {@code long} with the length of the file in iRODS, in
	 *            bytes.
	 */
	 ...
	 *
	 * @return {@code String} with the name of the resource group the file
	 ...
	 *            {@code String} with the name of the resource group, or
	 ...
	 *
	 * @param resourceName
	 *            {@code String} with the name of the resource, or blank if
	 *            not used (no null).
	 */
	 ...
	 *
	 * @return {@code String} with the absolute path to the physical file
	 *         on the resource.
	 */
	 ...
	 *
	 * @return {@code String} with the name of the owner of the file (iRODS
	 *         User Name)
	 */
	 ...
	 *
	 * @return {@code String} with the name of the zone that has the file
	 *         in the catalog.
	 */
	 ...
	 *
	 * @param dataOwnerZone
	 *            {@code String} with the name of the zone that hosts the
	 *            file.
	 */
	 ...
	 *            {@code String} with the absolute path to the parent of
	 *            this collection.
	 */
	...
	/**
	 * @return the objectPath {@code String} with the canonical path of the
