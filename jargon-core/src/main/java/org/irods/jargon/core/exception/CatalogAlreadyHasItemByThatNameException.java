...
public class CatalogAlreadyHasItemByThatNameException extends JargonException {
	...
	public CatalogAlreadyHasItemByThatNameException(String message,
			int underlyingIRODSExceptionCode) {
		super(message, underlyingIRODSExceptionCode);
	}

	public CatalogAlreadyHasItemByThatNameException(String message, Throwable cause,
			int underlyingIRODSExceptionCode) {
		super(message, cause, underlyingIRODSExceptionCode);
	}

	public CatalogAlreadyHasItemByThatNameException(Throwable cause,
			int underlyingIRODSExceptionCode) {
