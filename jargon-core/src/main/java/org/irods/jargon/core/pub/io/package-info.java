/**
 * This package is the primary public API for {@code java.io.*} interfaces to iRODS.  See the {@code org.irods.jargon.core.pub.*} directory
 ...
 *
 * Note that this package is dedicated to the {@code java.io.*} interfaces.  There are another set of public API in the {@code org.irods.jargon.core.pub.*}
 ...
 * operations that are not defined by the {@code java.io} interfaces.
 *
 */
