...
public enum RodsGenQueryEnum {
	...
	COL_R_RESC_ID("RESC_ID", 301), COL_R_RESC_NAME("RESC_NAME", 302), COL_R_ZONE_NAME(
			...
			"RESC_MODIFY_TIME", 312), COL_R_RESC_STATUS("RESC_STATUS", 313),
	// data obj info
	...
	// tickets
	COL_TICKET_ID("TICKET_ID", 2200), COL_TICKET_STRING("TICKET_STRING", 2201),
			COL_TICKET_TYPE("TICKET_TYPE", 2202), COL_TICKET_USER_ID("TICKET_USER_ID", 2203),
			COL_TICKET_OBJECT_ID("TICKET_OBJECT_ID", 2204), COL_TICKET_OBJECT_TYPE("TICKET_OBJECT_TYPE", 2205),
			COL_TICKET_USES_LIMIT("TICKET_USES_LIMIT", 2206), COL_TICKET_USES_COUNT("TICKET_USES_COUNT", 2207),
			COL_TICKET_EXPIRY_TS("TICKET_EXPIRY_TS", 2208), COL_TICKET_CREATE_TIME("TICKET_CREATE_TIME", 2209),
