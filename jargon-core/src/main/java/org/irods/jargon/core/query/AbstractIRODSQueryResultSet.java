...
/**
 * Abstract superclass for a simple set of results from some type of iRODS query, such as GenQuery or SimpleQuery.  This result set
 * will contain rows/columns, as well as column names.  This ResultSet is somewhat like a <code>java.sql.ResultSet</code>, but is greatly simplified.  
 * <p/>
 * Jargon may contain, in the future, an actual implementation of <code>java.sql.ResultSet</code>, and that implementation would wrap this simple result
 * set based on rows and columns, and delegate operations to this simpler implementation.
 * 
...
public abstract class AbstractIRODSQueryResultSet implements IRODSQueryResultSetInterface {
	...
	/* (non-Javadoc)
	 * @see org.irods.jargon.core.query.IRODSQueryResultSetInterface#getFirstResult()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.irods.jargon.core.query.IRODSQueryResultSetInterface#isHasMoreRecords()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.irods.jargon.core.query.IRODSQueryResultSetInterface#getNumberOfResultColumns()
	 */
	@Override
