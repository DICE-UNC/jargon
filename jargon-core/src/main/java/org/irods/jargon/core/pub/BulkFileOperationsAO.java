...
public interface BulkFileOperationsAO extends IRODSAccessObject {
	 ...
	 * @param absolutePathToIrodsCollectionToBeBundled
	 *            <code>String</code> with the absolute path to the collection that
	 *            will be the target of the extraction. The collection does not have
	 *            to exist.
	 * @param resourceNameWhereBundleWillBeStored
	 *            <code>String</code> with the target resource for the extraction.
	 *            This is optional and should be set to blank if not used (not
	 *            null).
	 * @param bundleType
	 *            {@link org.irods.jargon.core.packinstr.StructFileExtAndRegInp.BundleType}
	 *            that describes the desired bundle to be produced
	 * @throws JargonException
	 *             {@code JargonException}
	 */
	void createABundleFromIrodsFilesAndStoreInIrodsWithForceOption(String absolutePathToBundleFileToBeCreatedOnIrods,
			String absolutePathToIrodsCollectionToBeBundled, String resourceNameWhereBundleWillBeStored,
			BundleType bundleType) throws JargonException;
	 ...
	 * 
	 * @param absolutePathToBundleFileToBeCreatedOnIrods
	 *            <code>String</code> with the absolute path to a file on iRODS that
	 *            will store the created bundle.
	 * @param absolutePathToIrodsCollectionToBeBundled
	 *            <code>String</code> with the absolute path to a collection on
	 *            iRODS that will be the source of the bundle.
	 * @param resourceNameWhereBundleWillBeStored
	 *            <code>String</code> with the optional (leave blank if not used,
	 *            not null) iRODS resource where the bundle will be stored. * @param
	 *            bundleType
	 *            {@link org.irods.jargon.core.packinstr.StructFileExtAndRegInp.BundleType}
	 *            that describes the desired bundle to be produced
	 * @param bundleType
	 ...
	 *             {@code JargonException}
	 */
	void createABundleFromIrodsFilesAndStoreInIrods(String absolutePathToBundleFileToBeCreatedOnIrods,
			String absolutePathToIrodsCollectionToBeBundled, String resourceNameWhereBundleWillBeStored,
			BundleType bundleType) throws JargonException;
