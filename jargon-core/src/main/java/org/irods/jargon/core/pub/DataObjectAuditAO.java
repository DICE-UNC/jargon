...
public interface DataObjectAuditAO {
	 ...
	 * index for paging through very large data sets. The {@code AuditedAction}
	 * objects contain information about 'more results' as well as sequence numbers
	 * to aid in paging.
	 *
	 * @param irodsFile
	 ...
	 *             for iRODS error
	 */
	List<AuditedAction> findAllAuditRecordsForDataObject(IRODSFile irodsFile, int partialStart,
			int numberOfResultsDesired) throws FileNotFoundException, JargonException;

	/**
	 * Get an individual audit action for a data object, given that you know enough
	 ...
	 *             for iRODS error
	 */
	AuditedAction getAuditedActionForDataObject(IRODSFile irodsFile, String auditActionCode,
