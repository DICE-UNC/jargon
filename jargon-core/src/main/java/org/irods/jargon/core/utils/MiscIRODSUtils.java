...
public class MiscIRODSUtils {
	 ...
	 * 
	 * @param actualVersionOfServer
	 *            <code>String</code> that represents the actual version of a
	 *            server in question, such as is reported by the startup pack
	 * @param thisReleaseVersion
	 *            <code>String</code> that represents a test version number,
	 *            asking if the reported server version is at least this version
