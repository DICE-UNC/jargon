...
/**
 * Helper methods to generate dummy files and directories useful for Jargon testing
 *
...
public class FileGenerator {
    ...
    /**
     * Create a random file extension selected from the <code>fileExtensions</code> options
     *
     * @return <code>String</code> containing a random, though valid, file extension prepended with
     * a '.' character
     ...
     *
     * @param length <code>int</code> that determines the length of the <code>String</code> that is
     * generated.
     * @return <code>String</code> of n length composed of random alphabetic characters
     */
     ...
     *
     * @param length <code>int</code> that determines the length of the file name (not including the
     * extension this will be appended)
     * @return <code>String</code> which is a random file name plus a random extension
     * @throws TestingUtilsException
     */
    ...
    /**
     * Given a directory, generate a randomly named file with random data of provided length.
     *
     * @param fileDirectory <code>String</code> containing a an absolute path to valid directory on
     * the local file system. This absolute path must have a leading and trailing '/'.
     * @param length <code>long</code> containing the desired length of the file in bytes
     * @return <code>String</code> containing the full path to the generated file
     * @throws TestingUtilsException
     */
    ...
    /**
     * Handy method to generate a tree of files and collections with given parameters. This method
     * will recursively build a local file tree under a given absolute path. The collections are of
     * random number within a range, to a given depth, and containing files and subcollections given
     * the various size and range parameters. This method can provide a test-bed for various
