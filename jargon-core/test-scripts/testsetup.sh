...
exec `iadmin mkresc test1-resc "unix file system" cache localhost "/opt/iRODS/iRODS3.2/Vault1"`

exec `iadmin mkresc test1-resc2 "unix file system" cache localhost "/opt/iRODS/iRODS3.2/Vault2"`
