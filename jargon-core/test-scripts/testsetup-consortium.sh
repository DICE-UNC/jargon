...
iadmin mkresc test1-resc "unix file system"  mikesubuntu:/var/lib/irods/iRODS/Vault1

iadmin mkresc test1-resc2 "unix file system"  mikesubuntu:/var/lib/irods/iRODS/Vault2

iadmin mkresc test1-resc3 "unix file system"  mikesubuntu:/var/lib/irods/iRODS/Vault3
